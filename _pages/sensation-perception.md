...
<figure>
    ...
    <figcaption> Figure 1. An example of top-down processing. The words in the triangle read, "I love Paris in the the spring." The (probably unnoticed) repeated word "the" appears on two separate lines within the triangle. </figcaption>
</figure>

Notice anything odd while you were reading the text in the triangle? Did you notice the second “the”? If not, it’s likely because of top-down processing. Having a second “the” doesn’t make sense. We know this. Our brain knows this and doesn’t *expect* there to be a second one, so we have a tendency to skip right over it. In other words, your past experience has changed the way you perceive the writing in the triangle! A beginning reader—one who is relying more on bottom-up processing by carefully attending to each piece—would be less likely to make this error.
...
## Color vision
This image is an illustration of the opponent process theory of vision. The image depicts the Canadian flag. Where the familiar Canadian flag is a red maple leaf on a white background bordered by two red columns this image is different. It shows a green maple leaf on a black background bordered by green columns. If a person stares at the green and black flag and then diverts their eyes to a blank surface such as a wall an "after image" of the Canadian flag will appear to hover there, only it will appear in red and white! Exactly the opposite colors the person was just staring at. 
